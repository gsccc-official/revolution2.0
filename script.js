...
const SEG_DETAIL = {
  pen:   { short:"“Where the pen meets the heartbeat of struggle – <span class=\"bn\">লিখিত শব্দে জীবিত হয় সাহস ও সংগ্রামের গল্প।</span>”<br>Capture stories that echo bravery, sacrifice, and the untold journeys of heroes.", rules:["All submissions will be online via the official Facebook Submission Group.","Any AI-generated / AI-assisted or third-party assisted work will not be accepted.","Use the submission format & hashtags provided in the event description.","Segment Fee: 50 BDT (per segment)."] },
  pic:   { short:"“Through the eyes of today, moments of courage are immortalized – <span class=\"bn\">আজকের চোখে, সংগ্রামের মুহূর্তগুলো চিরস্থায়ী হয়ে ওঠে।</span>”<br>Show the revolution through powerful frames that reflect courage, equality, and expression.", rules:["All submissions will be online via the official Facebook Submission Group.","Any AI-generated / AI-assisted or third-party assisted work will not be accepted.","Use the submission format & hashtags provided in the event description.","Segment Fee: 50 BDT (per segment)."] },
  voice: { short:"“Unshackled voices, bearing the fire of change – <span class=\"bn\">মুক্ত কণ্ঠে, যাদের ভাষা প্রেরণা প্রজ্বলন করে।</span>”<br>Speak spontaneously, ignite minds, and let your voice become a beacon of courage.", rules:["All submissions will be online via the official Facebook Submission Group.","Any AI-generated / AI-assisted or third-party assisted work will not be accepted.","Use the submission format & hashtags provided in the event description.","Segment Fee: 50 BDT (per segment)."] },
  mic:   { short:"“Songs that weave the melody of hope – <span class=\"bn\">প্রত্যয়ের সুরে বোনা গান যা হৃদয় স্পর্শ করে।</span>”<br>Perform classics, original pieces, or patriotic songs that celebrate triumph, bravery, and inspiration.", rules:["Category A: Class 8–10.","Category B: Class 11–12 & HSC Batch 26.","All submissions will be online via the official Facebook Submission Group.","Any AI-generated / AI-assisted or third-party assisted work will not be accepted.","Segment Fee: 50 BDT (per segment)."] },
